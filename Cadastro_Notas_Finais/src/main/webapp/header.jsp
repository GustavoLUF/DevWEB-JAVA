...
<script>
function saudacao(){						//função que da uma saudação ao usuário Professor
	document.getElementById("saud").innerHTML="Olá, Professor.";
}

function construirArray(qtdElementos){		//função que controi um relogio + dia da semana + data
...
<body onload="atualizarDataHora()" onpageshow="saudacao()"> <!-- chama a função -->
	<b id="saud"></b>
    <div id="datahora"></div>
</body>
</html>